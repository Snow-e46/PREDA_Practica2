...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 1) {
            ...
            // Organización según la cantidad de parámetros adjuntos
            // Lógica para 1 parámetro
            if (args.length == 1) {

                // Posibilidades: -t // -h // fichero_entrada
                ...
                // Posibilidades: -t -h // -t fichero_entrada // -h fichero_entrada // fichero_entrada fichero_salida
                if ((args[0].equalsIgnoreCase("-t")) && (args[1].equalsIgnoreCase("-h"))) {
                    ...
                    System.err.println("Argumentos erróneos, puede solicitar ayuda introduciendo \"-h\"");
                ...
                // Posibilidades: -t -h fichero_entrada // -t fichero_entrada fichero_salida // -h fichero_entrada fichero_salida
                if ((args[0].equalsIgnoreCase("-t")) && (args[1].equalsIgnoreCase("-h"))) {
                ...
                // Implementación lógica para los 4 argumentos
